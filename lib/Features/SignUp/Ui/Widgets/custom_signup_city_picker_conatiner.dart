...
class CustomSignUpCityPickerConatiner extends StatelessWidget {
        ...
        showBottomSheet(
          ...
          builder: (context) {
            return ListView.separated(
              itemBuilder: (context, index) {
                return InkWell(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      BlocProvider.of<SignUpCubit>(context).cities[index],
              ...
              itemCount: BlocProvider.of<SignUpCubit>(context).cities.length,
            );
          },
        );
      },
      child: BlocBuilder<SignUpCubit, SignUpStates>(
        builder: (context, state) {
          return Container(
            ...
            child: Text(
              BlocProvider.of<SignUpCubit>(context).city,
